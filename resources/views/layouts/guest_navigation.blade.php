        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="'/shop'" :active="request()->routeIs('sliders')">
                        Shop
                    </x-nav-link>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="'/login'" :active="request()->routeIs('sliders')">
                            Login
                        </x-nav-link>
                    </div>

                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-nav-link :href="'/register'" :active="request()->routeIs('sliders')">
                            Register
                        </x-nav-link>
                    </div>
                @endisset
